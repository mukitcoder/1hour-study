...
const SkillDevelopment = () => {
    return (
        ...
        <div className="expertise-text-2 row mb-4">
          <div className="col-md-8 d-flex justify-content-center align-items-center mx-auto">
            <img className="img-fluid" src={abc3} alt="expertPic" />
            <h2 className="fw-bold">
            1 HOUR STUDY <span className="hero-text">ই-লার্নিং প্লাটফর্ম </span>থেকে কেন স্কিল ডেভেলপমেন্ট করবেন ?
            </h2>
          </div>
        </div>
          ...
          <div className="row g-5 pb-5">
            ...
            <div className="col-lg-4 col-md-6 col-sm-12">
              <div className="d-grid bg-white p-2 expertise-section">
                ...
                />
                <div className="text-center">
                  <h5 className="py-2">অভিজ্ঞ প্রশিক্ষক দ্বারা শিক্ষার্থীকে পাঠদান করা </h5>
                </div>
              </div>
            </div>
            <div className="col-lg-4 col-md-6 col-sm-12">
